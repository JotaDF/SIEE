...
<html>
    ...
    <body>
        ...
        <form method="post" action="control/inserir_estagiario.php">
            ...
            Senha:<input type="text" name="senha" size="60" required /><br/>
            ...
            compasicao Carga Horaria:<input type="text" name="composicao_carga_horaria" size="60" required /><br/>
            Carga Horaria:<input type="text" name="carga_horaria" size="60" required /><br/>
