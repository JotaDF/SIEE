        ...
        <table border="1">
            ...
            foreach ($lista as $resposta) {
                ...
                <tr>
                    ...
                    <!--
                    <td align="center">
                        <a href="form_alterar_resposta.php?id="><img src="imagens/alterar.svg" width="22" height="22" /></a>
                        <a href="#" onclick="excluir()"><img src="imagens/excluir.svg" width="22" height="22" /></a>
                    </td>
                     -->
                </tr>
                <?php
